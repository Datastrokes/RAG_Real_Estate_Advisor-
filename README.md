...
- RAGRealEstateAdvisor targets homebuyers, renters, real estate agents, and property investors seeking fast, accurate assistance.
- The tools I, have used in this project and technique are VS code, Python, RAG, OLLAMA, Gradio, Chroma, Hugging Face and LangChain. 

## Installation

1. Clone the repo: git clone https://github.com/Datastrokes/RAG_Real_Estate_Advisor-.git
2. cd RAG_Real_Estate_Advisor.
